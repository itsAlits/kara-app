      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute inset-0 p-6 flex flex-col justify-between">
          ...
          <div>
            ...
            {/* Description — expands in on hover */}
            <p className="text-white/80 leading-relaxed text-xs max-h-0 overflow-hidden opacity-0 group-hover:max-h-20 group-hover:opacity-100 transition-all duration-500 delay-100 mt-0 group-hover:mt-2">
              {project.desc}
            </p>
