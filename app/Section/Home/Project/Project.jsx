...
const projects = [
    {
        id: "01",
        title: "Zen Ubud Photography",
        category: "Photography",
        desc: "Get a photo product for menu project.",
        ...
        <Link href={`/Project/${project.id}`} className={`group relative overflow-hidden rounded-lg bg-gray-100 cursor-pointer block ${className}`}>
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-5 sm:p-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <span className={`text-[11px] font-medium px-2.5 py-1 rounded-full backdrop-blur-sm ${pillColour[project.category]}`}>
                        {project.category}
                    </span>
                </div>
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <ProjectCard
                            project={projects[0]}
                            className="h-64 sm:h-80 sm:flex-2"
                        />
                        <ProjectCard
                            project={projects[1]}
                            className="h-64 sm:h-80 sm:flex-1"
                        />
                    </div>
                    {/* Row 2 — flipped ratio */}
                    <div className="flex flex-col sm:flex-row gap-4">
